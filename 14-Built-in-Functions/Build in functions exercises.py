...
# Return a new list with the words that h
# ave a length equal to the number.
...
# It should return a list with only the odd
...
# It should return a list with counts of how many
#  “a” characters appear per string.
# Do NOT use list comprehension.
#
# EXAMPLES:
